...
import 'package:bookia_app/features/authentication/data/repositories/auth_repo.dart';
...
class AuthCubit extends Cubit<AuthState> {
  ...
  Future<void> login() async {
    ...
    final data = await AuthRepo.loginRepo(params);
  ...
  Future<void> register() async {
    ...
    final data = await AuthRepo.registerRepo(params);
